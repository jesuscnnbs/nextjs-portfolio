...
export const SideBarLink = ({
  ...
  return (
    <MotionLink
      ...
      className={`writing-vertical h-16 sm:h-24 shrink-0 flex items-center justify-center border-r-2 text-secondary-content text-xs sm:text-sm transition-all w-full ${
        selected === value
